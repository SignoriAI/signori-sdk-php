...
All notable changes to the Signori PHP SDK.
...
### Added
- `Signori::client()` — factory with env-var config and explicit parameter support
...
- Integration tests with auto-skip when SIGNORI_API_KEY is not set
